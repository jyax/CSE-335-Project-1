...
void ScoreBoard::Draw(std::shared_ptr<wxGraphicsContext> graphics) {
    ...
    // Set the font size and color for the scores
    graphics->SetFont(wxFont(ScoreSize, wxFONTFAMILY_SWISS, wxFONTSTYLE_NORMAL, wxFONTWEIGHT_BOLD), FontColor);
    ...
    graphics->SetFont(wxFont(LabelSize, wxFONTFAMILY_SWISS, wxFONTSTYLE_NORMAL, wxFONTWEIGHT_BOLD), FontColor);
